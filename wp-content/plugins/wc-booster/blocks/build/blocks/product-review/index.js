...
const Edit = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-block-instance-${instanceId}-${clientId}`
    });
  }, []);
  ...
  const item = (post, reviewId) => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-card-wrapper woocommerce`,
      style: wrapperStyle
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-inner-wrapper`,
      style: productReviewBodyStyle
    }, imageType === 'reviewer' ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-avatar`,
      ...
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-product-img`
      ...
      style: ratingStyle,
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-rating`,
      dangerouslySetInnerHTML: {
        __html: selectedReview.rating
      }
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-review-meta`
    }, enableTitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-title`,
      style: titleStyle
    }, post.title.rendered), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-date-author`
    }, enableAuthor && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-review-author`,
      style: authorStyle
    }, selectedReview.author_name), enableDate && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-date`,
      style: dateStyle
    }, selectedReview.date)), enableComment && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-comment-text`,
      style: commentStyle
    }, (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.wordTrim)(selectedReview.comment_text, excerptLength)), ratingPosition === 'bottom' && enableRating && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      style: ratingStyle,
      className: `${_constants__WEBPACK_IMPORTED_MODULE_10__.prefix}-product-review-rating`,
      dangerouslySetInnerHTML: {
        __html: selectedReview.rating
  ...
  const getSliderSettings = length => {
    ...
    const arrowLeftStyle = {
      ...
      height: arrowHeight + "px",
      width: arrowWidth + "px",
      ...(0,_helpers__WEBPACK_IMPORTED_MODULE_11__.getDimensionStyle)(["top", "", "left"], arrowPosition)
    };
    const Next = () => {
...
const applyWithSelect = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.withSelect)(select => {
  ...
  const productQuery = (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.pickBy)({
    per_page: -1,
    _embed: true
  }, value => !(0,_helpers__WEBPACK_IMPORTED_MODULE_11__.isUndefined)(value));
  var allProduct = getEntityRecords("postType", "product", productQuery);
  return {
    allProduct
  };
});
...
const InspectorPanel = props => {
    ...
    if (productId && productId !== "0") {
      ...
      if (index !== -1) {
        ...
        review_options = product.wc_booster_product_reviews.map((review, index) => ({
          label: (0,_helpers__WEBPACK_IMPORTED_MODULE_15__.wordTrim)(review.comment_text, 4),
          value: index + 1
        }));
      }
    }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorAdvancedControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_exporter__WEBPACK_IMPORTED_MODULE_13__["default"], {
    ...
    beforeIcon: ""
  }), allProduct.length > (0,_helpers__WEBPACK_IMPORTED_MODULE_15__.getResponsiveRangeVal)(slidesToShow) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_7__.SwitchControl, {
  ...
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_responsive_range_wrapper__WEBPACK_IMPORTED_MODULE_16__["default"], {
