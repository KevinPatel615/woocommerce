...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_control(new supermarketecommercestore_Tab_Control($wp_customize, 'supermarketecommercestore_top_header_tabs', array(
	   ...
	   'buttons' => array(
	      array(
            ...
            'fields' => array(
            	'hide_show_sticky',
				'topheader_signintext',
				'topheader_registertext',
            	'topheader_btntext',
				'topheader_fblink',
	...
	// topheader signintext
	$topheadersignintext = esc_html__('Sign In', 'supermarket-ecommerce-store' );
	$wp_customize->add_setting(
    	'topheader_signintext',
    	array(
			'default' => $topheadersignintext,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 6,
		)
	...
	$wp_customize->add_control( 
		'topheader_signintext',
		array(
		    'label'   		=> __('Sign In Text','supermarket-ecommerce-store'),
		    'section'		=> 'top_header',
			'type' 			=> 'text',
			'transport'         => $selective_refresh,
		)  
	...
	// topheader registertext
	$topheaderregistertext = esc_html__('Register', 'supermarket-ecommerce-store' );
	$wp_customize->add_setting(
    	'topheader_registertext',
    	array(
			'default' => $topheaderregistertext,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 6,
		)
	...
	$wp_customize->add_control( 
		'topheader_registertext',
		array(
		    'label'   		=> __('Register Text','supermarket-ecommerce-store'),
		    'section'		=> 'top_header',
			'type' 			=> 'text',
			'transport'         => $selective_refresh,
		)  
