 ...
 */
function supermarketecommercestore_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function supermarketecommercestore_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function supermarketecommercestore_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function supermarketecommercestore_sanitize_float( $input ) {
 ...
 */
function supermarketecommercestore_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function supermarketecommercestore_sanitize_html( $html ) {
 ...
 */
function supermarketecommercestore_sanitize_image( $image, $setting ) {
 ...
 */
function supermarketecommercestore_sanitize_nohtml( $nohtml ) {
 ...
 */
function supermarketecommercestore_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function supermarketecommercestore_sanitize_range_value( $number, $setting ) {
 ...
 */
function supermarketecommercestore_sanitize_select( $input, $setting ) {
 ...
 */
function supermarketecommercestore_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function supermarketecommercestore_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function supermarketecommercestore_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
