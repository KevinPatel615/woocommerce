( function( api ) {
	...
	api.sectionConstructor['supermarket_ecommerce_storeplugin-section'] = api.Section.extend( {
...
function supermarketecommercestoresfrontpagesectionsscroll( section_id ){
