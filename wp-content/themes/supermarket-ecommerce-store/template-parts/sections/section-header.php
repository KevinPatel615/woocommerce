...
<!-- Header Area -->
	...
	<?php 
		...
		// header 
		$topheader_signintext = esc_attr(get_theme_mod('topheader_signintext','Sign In'));
		$topheader_registertext = esc_attr(get_theme_mod('topheader_registertext','Register'));
								...
								if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
									...
									<div class="col-lg-2 col-md-12 col-sm-12 pd-0">
										<a class="signin" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
											<?php echo apply_filters('supermarketecommercestore_topheader', $topheader_signintext); ?>
										</a>
										<a class="signup" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
											<?php echo apply_filters('supermarketecommercestore_topheader', $topheader_registertext); ?>
										</a>			
									</div>
								<?php } ?>
							</div>
