...
if ( ! function_exists( 'omega_online_store_sanitize_select' ) ) :
    ...
    function omega_online_store_sanitize_select( $omega_online_store_input, $omega_online_store_setting ) {
        ...
        $choices = $omega_online_store_setting->manager->get_control( $omega_online_store_setting->id )->choices;
        return ( array_key_exists( $omega_online_store_input, $choices ) ? $omega_online_store_input : $omega_online_store_setting->default );
    }
