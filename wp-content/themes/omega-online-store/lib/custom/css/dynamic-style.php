...
function omega_online_store_dynamic_css(){
    ...
    $logo_width_range = get_theme_mod('logo_width_range', $omega_online_store_default['logo_width_range']);
    $omega_online_store_border_color = get_theme_mod('omega_online_store_border_color');
    $background_color = get_theme_mod('background_color', $omega_online_store_default['omega_online_store_background_color']);
