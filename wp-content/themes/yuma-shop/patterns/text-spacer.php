...
<h2 class="wp-block-heading has-text-align-center has-large-font-size" style="letter-spacing:30px;line-height:1.7;text-transform:uppercase"><?php esc_html_e( 'Treat Your Feet', 'yuma-shop' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->