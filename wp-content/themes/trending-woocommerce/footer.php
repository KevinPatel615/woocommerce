...
<footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
  <div class="footer-overlay">
    ...
    $trending_woocommerce_newsletter = best_shop_get_setting( 'subscription_shortcode' );

    if ( $active_sidebars && $sidebar_count > 0 || $trending_woocommerce_newsletter !== '' ) {
      ?>
    <div class="footer-top">
      <div class="container">
        <?php

        if ( $trending_woocommerce_newsletter ) {
          ?>
        <div class="footer-newsletter-section">
          <?php
          the_widget( 'best_shop_newsletter_widget', array( 'newsletter_shortcode' => $trending_woocommerce_newsletter ) );
          ?>
        </div>
        <?php
